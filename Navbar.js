    ...
    return (
      <nav className="site-header sticky-top py-1">
        <div className="container d-flex flex-column flex-md-row justify-content-between">
          ...
          <a className="py-2 d-none d-md-inline-block" href="#pricing">Pricing</a>
          <a className="py-2 d-none d-md-inline-block" href="#testimonials">Testimonials</a>
          <a className="py-2 d-none d-md-inline-block" href="#blog">Blog</a>
